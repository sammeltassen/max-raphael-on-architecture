...
Translator's notes have been added with either `<!-- HTML comments -->` or [between brackets].
:::
...
_Dedicated to my students at the Volkshochschule Groß-Berlin in memory of collective work._^[Commentary: @sec-dedication]

Motto:

> **For who can see the comings and goings of a god, if the god does not wish to be seen? (Odyssee, X 573)**^[Commentary: @sec-motto]
