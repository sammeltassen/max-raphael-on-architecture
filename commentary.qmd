...
The motto of _The Doric Temple_ is taken from the end of Book X of The Odyssey. Odysseus and his men are about to leave the island Aeaea after staying in the palace of the goddess Circe. While Circe had initially cast a spell on a cohort of his men, transforming them into pigs, Odysseus was able to force Circe to break the spell with the help of Hermes, and to have her welcome him and his men. After enjoying Circe's hospitality for a year, Odysseus is reminded of his homeland and decides to set sail again. His men are in utter despair after hearing that their next destination is the underworld to consult the ghost of Teiresias, following Circe's instructions. This is when she passes by unnoticed:
...
Body text and footnote 7a:

> To these numbers belong by no means the bay, i.e. the bisection of two columns and the connection of their inner half across the intercolumniation, or in other words the direct connection of parts unrelated to the whole. This is an unhistoric projection (by an historicist era) of a concept of Roman or Christian architecture onto Greek architecture - with which it has nothing in common.
...
Statue is a like a pointed wedge: the cylindric base is expanded and eventually exceeded upwards. The architect’s column has the greatest diameter at the bottom and the smallest on top. Tapering originates in column’s function to carry force. Its meaning is that the forces are collected and unloaded at the Echinus, showing the willingness to take on loads, which it is then offered in the abacus. Even entasis can be expressed through the penetration of the force. The column design can be explained on the basis of an interplay of centrifugal and centripetal forces, dependent on the static conflict between support and load. The sculpture can be in contrary explained on the basis of the human body.
Bottom of Hera sculpture contains inversed cannelures. Follow the cylindrical surface, having a clear spatial function. Cannelures are a consequence of the forces: centripetal where they pull the cylinder inwards and centrifugal where they push outwards. The original cylindrical surface is dissolved into actual surfaces from opposing curves and imaginary lines which run parallel over the ridges. Ridges and vales run continuous over the column inclination. The unbrokenness, straightness and geometrical-rational rigidity is not present in the Hera of Samos. Here, only small curves are used with sometimes concave, sometimes convex curves, which present a wealth of liveliness, breath, warmth determined by humans as bodily-spiritual creature, in contrast to mechanical forces. The spatial function of sculpture are surface tensions, which  realising aim (Konkretisierungsziel) is the human. The function of the architectural work the tensions between centre and periphery which realising aim is the activity of mechanical forces. 
The designed level/plane (surface?) which prevents the viewer to revolve around the cylindrical curve, is in case of the sculpture finalised in the contours of the figure, in harmony with the anatomy of the female body. Finite body, despite the universality of its meaning. The boundary of the column is principally of secondary importance: the designed place (Modellierungsebene) reaches over the column and the intercolumniation to the next column. It connects the entire front [imaginary place dissecting columns]. It is the unified, imaginary, resting plane, from which the spatial movements in the front start to differentiate. They are twofold. If the viewer faces the front of the temple, the centre columns are seen frontally, the second slightly rotated and the corner columns heavily rotated.
